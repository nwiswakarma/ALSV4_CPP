...
#include "ALSMCharacter.generated.h"

/**
 * Specialized character class, with additional features like held object etc.
 */
UCLASS(Blueprintable, BlueprintType)
class ALSV4_CPP_API AALSMCharacter : public AALSMBaseCharacter
{
	GENERATED_BODY()

public:
	AALSMCharacter(const FObjectInitializer& ObjectInitializer);
	...
	virtual ECollisionChannel GetThirdPersonTraceParams(
        FVector& TraceOrigin,
        float& TraceRadius
        ) override;
