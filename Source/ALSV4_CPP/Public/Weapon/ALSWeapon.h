...
class AALSWeapon : public AActor
{
	...
	virtual void OnEquip(const AALSWeapon* LastWeapon);
	...
	virtual void OnEnterInventory(AALSCharacter* NewOwner);
	...
	class AALSCharacter* GetPawnOwner() const;
...
protected:
	...
	virtual void FireWeapon() PURE_VIRTUAL(AALSWeapon::FireWeapon,);
