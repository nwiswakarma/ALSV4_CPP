...
#include "ALSMPlayerCameraManager.generated.h"
...
class ALSV4_CPP_API AALSMPlayerCameraManager : public APlayerCameraManager
{
	GENERATED_BODY()

public:
	AALSMPlayerCameraManager();

	UFUNCTION(BlueprintCallable)
	void OnPossess(AALSMBaseCharacter* NewCharacter);
...
public:
	...
	AALSMBaseCharacter* ControlledCharacter = nullptr;
